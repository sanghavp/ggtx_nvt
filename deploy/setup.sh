...
echo "mysql> CREATE USER 'nvt'@'localhost' IDENTIFIED BY 'Abcd1234@';"
echo "mysql> GRANT ALL PRIVILEGES ON ggtx_nvt.* TO 'nvt'@'localhost';"
...
echo "- Chạy certbot để lấy SSL: sudo certbot --nginx -d nvt.sanghh.space"
